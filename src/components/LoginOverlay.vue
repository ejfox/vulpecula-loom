<template>
  <div v-if="!isAuthenticated"
    ...
    <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl max-w-md w-full mx-4 transform transition-all duration-300 ease-out">
      <!-- Logo/Branding -->
        ...
        <TransitionGroup name="slide">
          <div v-if="isSignUp && password" key="password-requirements" class="space-y-2">
            ...
            <ul class="space-y-1 text-sm">
              <li class="flex items-center space-x-2" :class="{ 'text-green-600 dark:text-green-400': password.length >= 8, 'text-gray-500 dark:text-gray-400': password.length < 8 }">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path v-if="password.length >= 8" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  <circle v-else cx="12" cy="12" r="10" stroke-width="2" />
                </svg>
                <span>At least 8 characters</span>
              </li>
              <li class="flex items-center space-x-2" :class="{ 'text-green-600 dark:text-green-400': /[A-Z]/.test(password), 'text-gray-500 dark:text-gray-400': !/[A-Z]/.test(password) }">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path v-if="/[A-Z]/.test(password)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  <circle v-else cx="12" cy="12" r="10" stroke-width="2" />
                </svg>
              ...
              <li class="flex items-center space-x-2" :class="{ 'text-green-600 dark:text-green-400': /[0-9]/.test(password), 'text-gray-500 dark:text-gray-400': !/[0-9]/.test(password) }">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path v-if="/[0-9]/.test(password)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  <circle v-else cx="12" cy="12" r="10" stroke-width="2" />
                </svg>
